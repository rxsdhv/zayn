...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hai", "Aku mau tanya deh", "question").then(function () {
    Swal.fire("Jawab yg bener ya!").then(function () {
      Swal.fire("Jangan coba-coba bohong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} masih belum yakin sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`WAH KEREN, feel so loved by ${nama} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Hehe ${sender} sayang ${nama}`).then(function () {
